# 1 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "acquireToHDMIwithZynq_wrapper.bit.bin";
  clocking0: clocking0 {
  ...
  acquireToDisplay_AXI_0: acquireToDisplay_AXI@43c00000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,acquireToDisplay-AXI-1.0";
   status = "okay";
   clock-names = "s00_axi_aclk";
   xlnx,s00-axi-addr-width = <6>;
   xlnx,ip-name = "acquireToDisplay_AXI";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x43c00000 0x10000>;
   clocks = <&clkc 15>;
   xlnx,name = "acquireToDisplay_AXI_0";
  };
  enhancedPwmAXI_0: enhancedPwmAXI@43c10000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,enhancedPwmAXI-1.0";
   status = "okay";
   clock-names = "s00_axi_aclk";
   xlnx,s00-axi-addr-width = <4>;
   xlnx,ip-name = "enhancedPwmAXI";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x43c10000 0x10000>;
   clocks = <&clkc 15>;
   xlnx,name = "enhancedPwmAXI_0";
  };
  enhancedPwmAXI_1: enhancedPwmAXI@43c20000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,enhancedPwmAXI-1.0";
   status = "okay";
   clock-names = "s00_axi_aclk";
   ...
   clocks = <&clkc 15>;
   xlnx,name = "enhancedPwmAXI_1";
  };
 };
};
# 4 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "C:\\VitisWorkspace\\lab6_platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7z010";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x43c00000 &acquireToDisplay_AXI_0 0x43c00000 0x10000>,
         <0x43c10000 &enhancedPwmAXI_0 0x43c10000 0x10000>,
         <0x43c20000 &enhancedPwmAXI_1 0x43c20000 0x10000>,
