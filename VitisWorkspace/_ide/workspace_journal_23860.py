# 2025-12-08T21:17:01.536906200
import vitis

client = vitis.create_client()
client.set_workspace(path="C:/VitisWorkspace")

client.delete_component(name="lab6_application")

client.delete_component(name="componentName")

client.delete_component(name="lab6_platform")

client.delete_component(name="componentName")

advanced_options = client.create_advanced_options_dict(dt_overlay="0")

platform = client.create_platform_component(name = "lab6_platform",hw_design = "C:\EENG484\v2\acquireToHDMIwithZynq_wrapper.xsa",os = "standalone",cpu = "ps7_cortexa9_0",domain_name = "standalone_ps7_cortexa9_0",no_boot_bsp = True,generate_dtb = False,advanced_options = advanced_options,compiler = "gcc")
