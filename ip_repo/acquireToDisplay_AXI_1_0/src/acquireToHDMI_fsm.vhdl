...
begin
	...
	begin
		case state is		
            when RESET_STATE  =>  cw <=  "0011100000001111111111"; --based on this, CW is 22 bits
            ...
            when WRITE_CH1_BRAM_STATE => cw <=    "1010000001010010111111"; --CHANGED BIT 12 FROM 0 TO 1, REVERT IF FUCKY
            ...
            when WRITE_CH2_BRAM_STATE => cw <= "1010000010100010111111"; --CHANGED BIT 13 FROM 0 TO 1, REVERT IF FUCKY
