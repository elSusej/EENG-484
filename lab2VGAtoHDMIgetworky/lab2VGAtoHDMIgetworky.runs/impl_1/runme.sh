...
HD_PWD='C:/EENG 484/lab2VGAtoHDMIgetworky/lab2VGAtoHDMIgetworky.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scopeToHdmi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scopeToHdmi.tcl -notrace
