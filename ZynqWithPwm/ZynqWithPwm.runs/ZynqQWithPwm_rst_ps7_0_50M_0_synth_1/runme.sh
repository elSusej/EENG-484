...
HD_PWD='C:/EENG 484/ZynqWithPwm/ZynqWithPwm.runs/ZynqQWithPwm_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqQWithPwm_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZynqQWithPwm_rst_ps7_0_50M_0.tcl
