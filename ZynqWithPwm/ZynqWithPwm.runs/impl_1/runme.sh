...
HD_PWD='C:/EENG 484/ZynqWithPwm/ZynqWithPwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqQWithPwm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZynqQWithPwm_wrapper.tcl -notrace
