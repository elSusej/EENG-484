...
--               484/ZynqWithPwm/ZynqWithPwm.gen/sources_1/bd/ZynqQWithPwm/ip/ZynqQWithPwm_enhancedPwmAXI_0_0/ZynqQWithPwm_enhancedPwmAXI_0_0_sim_netlist.vhdl}
...
entity \ZynqQWithPwm_enhancedPwmAXI_0_0_genericCompare__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME of \ZynqQWithPwm_enhancedPwmAXI_0_0_genericCompare__parameterized1\ : entity is "genericCompare";
end \ZynqQWithPwm_enhancedPwmAXI_0_0_genericCompare__parameterized1\;

architecture STRUCTURE of \ZynqQWithPwm_enhancedPwmAXI_0_0_genericCompare__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZynqQWithPwm_enhancedPwmAXI_0_0_genericCounter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZynqQWithPwm_enhancedPwmAXI_0_0_genericCounter : entity is "genericCounter";
end ZynqQWithPwm_enhancedPwmAXI_0_0_genericCounter;

architecture STRUCTURE of ZynqQWithPwm_enhancedPwmAXI_0_0_genericCounter is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal p_2_in : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal rollOver_ext_INST_0_i_1_n_0 : STD_LOGIC;
  signal tmp : STD_LOGIC_VECTOR ( 7 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \dutyCycle_int[8]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of rollOver_ext_INST_0_i_1 : label is "soft_lutpair2";
...
\dutyCycle_int[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
rollOver_ext_INST_0: unisim.vcomponents.LUT6
    generic map(
...
rollOver_ext_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwm is
  port (
    pwmSignal_ext : out STD_LOGIC;
    rollOver_ext : out STD_LOGIC;
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    ...
    \s00_axi_rdata[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    axi_araddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \dutyCycle_int_reg[8]_0\ : in STD_LOGIC_VECTOR ( 8 downto 0 );
    s00_axi_aresetn : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwm : entity is "enhancedPwm";
end ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwm;

architecture STRUCTURE of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwm is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal counterEqualPeriod : STD_LOGIC;
  signal counter_inst_n_2 : STD_LOGIC;
  signal counter_inst_n_3 : STD_LOGIC;
  signal counter_inst_n_4 : STD_LOGIC;
  signal counter_inst_n_5 : STD_LOGIC;
  signal counter_inst_n_6 : STD_LOGIC;
  signal counter_inst_n_7 : STD_LOGIC;
  signal counter_inst_n_8 : STD_LOGIC;
  signal counter_inst_n_9 : STD_LOGIC;
  signal dutyCycle_int : STD_LOGIC_VECTOR ( 8 downto 0 );
begin
  SR(0) <= \^sr\(0);
counter_inst: entity work.ZynqQWithPwm_enhancedPwmAXI_0_0_genericCounter
     port map (
      DI(3) => counter_inst_n_6,
      DI(2) => counter_inst_n_7,
      DI(1) => counter_inst_n_8,
      DI(0) => counter_inst_n_9,
      E(0) => counterEqualPeriod,
      Q(7 downto 0) => dutyCycle_int(7 downto 0),
      S(3) => counter_inst_n_2,
      S(2) => counter_inst_n_3,
      S(1) => counter_inst_n_4,
      S(0) => counter_inst_n_5,
      SR(0) => \^sr\(0),
      ...
      \s00_axi_rdata[7]\(7 downto 0) => Q(7 downto 0),
      \s00_axi_rdata[7]_0\(7 downto 0) => \s00_axi_rdata[7]\(7 downto 0),
      \s00_axi_rdata[7]_1\(7 downto 0) => \dutyCycle_int_reg[8]_0\(7 downto 0)
    );
dutyCompare: entity work.\ZynqQWithPwm_enhancedPwmAXI_0_0_genericCompare__parameterized1\
     port map (
      DI(3) => counter_inst_n_6,
      DI(2) => counter_inst_n_7,
      DI(1) => counter_inst_n_8,
...
\dutyCycle_int_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
...
\dutyCycle_int_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
\dutyCycle_int_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => counterEqualPeriod,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI : entity is "enhancedPwmAXI_slave_lite_v1_0_S00_AXI";
end ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI is
  ...
  signal enhancedPwm_inst_n_10 : STD_LOGIC;
...
enhancedPwm_inst: entity work.ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwm
     port map (
      Q(7 downto 0) => slv_reg2(7 downto 0),
      SR(0) => enhancedPwm_inst_n_10,
      axi_araddr(1 downto 0) => axi_araddr(3 downto 2),
      \dutyCycle_int_reg[8]_0\(8 downto 0) => slv_reg0(8 downto 0),
      enb_ext => enb_ext,
      pwmSignal_ext => pwmSignal_ext,
      rollOver_ext => rollOver_ext,
      s00_axi_aclk => s00_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI : entity is "enhancedPwmAXI";
end ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI;

architecture STRUCTURE of ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI is
begin
enhancedPwmAXI_slave_lite_v1_0_S00_AXI_inst: entity work.ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ZynqQWithPwm_enhancedPwmAXI_0_0 is
  port (
    enb_ext : in STD_LOGIC;
    pwmSignal_ext : out STD_LOGIC;
    rollOver_ext : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of ZynqQWithPwm_enhancedPwmAXI_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ZynqQWithPwm_enhancedPwmAXI_0_0 : entity is "ZynqQWithPwm_enhancedPwmAXI_0_0,enhancedPwmAXI,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ZynqQWithPwm_enhancedPwmAXI_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of ZynqQWithPwm_enhancedPwmAXI_0_0 : entity is "enhancedPwmAXI,Vivado 2025.1";
end ZynqQWithPwm_enhancedPwmAXI_0_0;

architecture STRUCTURE of ZynqQWithPwm_enhancedPwmAXI_0_0 is
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ZynqQWithPwm_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of s00_axi_awaddr : signal is "XIL_INTERFACENAME S00_AXI, WIZ_DATA_WIDTH 32, WIZ_NUM_REG 4, SUPPORTS_NARROW_BURST 0, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 50000000, ID_WIDTH 0, ADDR_WIDTH 4, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, NUM_READ_OUTSTANDING 8, NUM_WRITE_OUTSTANDING 8, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN ZynqQWithPwm_processing_system7_0_0_FCLK_CLK0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
...
U0: entity work.ZynqQWithPwm_enhancedPwmAXI_0_0_enhancedPwmAXI
     port map (
