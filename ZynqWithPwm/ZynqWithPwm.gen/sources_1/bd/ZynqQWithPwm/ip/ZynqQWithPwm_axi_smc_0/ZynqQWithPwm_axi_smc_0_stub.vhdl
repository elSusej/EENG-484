...
-- Date        : Wed Nov 19 14:26:32 2025
-- Host        : DESKTOP-BLLF4DN running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub {c:/EENG
--               484/ZynqWithPwm/ZynqWithPwm.gen/sources_1/bd/ZynqQWithPwm/ip/ZynqQWithPwm_axi_smc_0/ZynqQWithPwm_axi_smc_0_stub.vhdl}
-- Design      : ZynqQWithPwm_axi_smc_0
...
entity ZynqQWithPwm_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of ZynqQWithPwm_axi_smc_0 : entity is "ZynqQWithPwm_axi_smc_0,bd_7823,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of ZynqQWithPwm_axi_smc_0 : entity is "ZynqQWithPwm_axi_smc_0,bd_7823,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of ZynqQWithPwm_axi_smc_0 : entity is "yes";
end ZynqQWithPwm_axi_smc_0;

architecture stub of ZynqQWithPwm_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN ZynqQWithPwm_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_7823,Vivado 2025.1";
begin
end;
