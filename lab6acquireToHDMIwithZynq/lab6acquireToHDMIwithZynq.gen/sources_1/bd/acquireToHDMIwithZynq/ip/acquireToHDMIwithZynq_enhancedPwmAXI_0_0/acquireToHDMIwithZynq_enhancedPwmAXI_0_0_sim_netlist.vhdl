...
-- Command     : write_vhdl -force -mode funcsim -rename_top acquireToHDMIwithZynq_enhancedPwmAXI_0_0 -prefix
--               acquireToHDMIwithZynq_enhancedPwmAXI_0_0_ acquireToHDMIwithZynq_enhancedPwmAXI_0_0_sim_netlist.vhdl
-- Design      : acquireToHDMIwithZynq_enhancedPwmAXI_0_0
...
entity \acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCompare__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME of \acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCompare__parameterized1\ : entity is "genericCompare";
end \acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCompare__parameterized1\;

architecture STRUCTURE of \acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCompare__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCounter is
  port (
...
end acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCounter;

architecture STRUCTURE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCounter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwm is
  port (
    pwmSignal_ext : out STD_LOGIC;
    rollOver_ext : out STD_LOGIC;
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
end acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwm;

architecture STRUCTURE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwm is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
begin
  SR(0) <= \^sr\(0);
counter_inst: entity work.acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCounter
     port map (
...
dutyCompare: entity work.\acquireToHDMIwithZynq_enhancedPwmAXI_0_0_genericCompare__parameterized1\
     port map (
      DI(3) => counter_inst_n_6,
      DI(2) => counter_inst_n_7,
      DI(1) => counter_inst_n_8,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI is
  port (
...
end acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI is
...
enhancedPwm_inst: entity work.acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwm
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI is
  port (
...
end acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI;

architecture STRUCTURE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI is
begin
enhancedPwmAXI_slave_lite_v1_0_S00_AXI_inst: entity work.acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI_slave_lite_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity acquireToHDMIwithZynq_enhancedPwmAXI_0_0 is
  port (
    enb_ext : in STD_LOGIC;
    pwmSignal_ext : out STD_LOGIC;
    rollOver_ext : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of acquireToHDMIwithZynq_enhancedPwmAXI_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0 : entity is "acquireToHDMIwithZynq_enhancedPwmAXI_0_0,enhancedPwmAXI,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of acquireToHDMIwithZynq_enhancedPwmAXI_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of acquireToHDMIwithZynq_enhancedPwmAXI_0_0 : entity is "enhancedPwmAXI,Vivado 2025.1";
end acquireToHDMIwithZynq_enhancedPwmAXI_0_0;

architecture STRUCTURE of acquireToHDMIwithZynq_enhancedPwmAXI_0_0 is
...
U0: entity work.acquireToHDMIwithZynq_enhancedPwmAXI_0_0_enhancedPwmAXI
     port map (
