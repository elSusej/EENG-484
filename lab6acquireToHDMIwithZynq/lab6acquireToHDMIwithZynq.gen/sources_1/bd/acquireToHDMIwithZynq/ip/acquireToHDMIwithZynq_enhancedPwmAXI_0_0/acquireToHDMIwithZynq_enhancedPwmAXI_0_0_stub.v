...
// Command     : write_verilog -force -mode synth_stub -rename_top acquireToHDMIwithZynq_enhancedPwmAXI_0_0 -prefix
//               acquireToHDMIwithZynq_enhancedPwmAXI_0_0_ acquireToHDMIwithZynq_enhancedPwmAXI_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "acquireToHDMIwithZynq_enhancedPwmAXI_0_0,enhancedPwmAXI,{}" *) (* core_generation_info = "acquireToHDMIwithZynq_enhancedPwmAXI_0_0,enhancedPwmAXI,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=enhancedPwmAXI,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "enhancedPwmAXI,Vivado 2025.1" *) 
module acquireToHDMIwithZynq_enhancedPwmAXI_0_0(enb_ext, pwmSignal_ext, rollOver_ext, 
