...
package scopeToHdmi_package is
    ...
    constant V_TOTAL : STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(750, VIDEO_WIDTH_IN_BITS));
    ...
    constant B_EDGE : STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(700, VIDEO_WIDTH_IN_BITS));
    ...
    constant CURSOR_R : STD_LOGIC_VECTOR(7 downto 0) := X"FF";
    constant CURSOR_G : STD_LOGIC_VECTOR(7 downto 0) := X"80";
    constant CURSOR_B : STD_LOGIC_VECTOR(7 downto 0) := X"00";
...
component clk_wiz_0 is --don't have to redeclare in acquire package right?
    PORT( 
