...
--Command     : generate_target acquireToHDMIwithZynq_wrapper.bd
--Design      : acquireToHDMIwithZynq_wrapper
...
entity acquireToHDMIwithZynq_wrapper is
  port (
...
end acquireToHDMIwithZynq_wrapper;

architecture STRUCTURE of acquireToHDMIwithZynq_wrapper is
  component acquireToHDMIwithZynq is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component acquireToHDMIwithZynq;
begin
acquireToHDMIwithZynq_i: component acquireToHDMIwithZynq
     port map (
      ...
      an7606conv_ext_0 => an7606conv_ext_0,
