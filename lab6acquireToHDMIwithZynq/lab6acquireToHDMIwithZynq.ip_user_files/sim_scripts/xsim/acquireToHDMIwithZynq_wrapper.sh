...
#
# Script generated by Vivado on Tue Dec 09 13:31:19 -0700 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : acquireToHDMIwithZynq_wrapper.sh
...
#
# Usage        : acquireToHDMIwithZynq_wrapper.sh
#                acquireToHDMIwithZynq_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                acquireToHDMIwithZynq_wrapper.sh [-reset_run]
#                acquireToHDMIwithZynq_wrapper.sh [-reset_log]
#                acquireToHDMIwithZynq_wrapper.sh [-help]
#
...
# script info
echo -e "acquireToHDMIwithZynq_wrapper.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./acquireToHDMIwithZynq_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L blk_mem_gen_v8_4_11 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot acquireToHDMIwithZynq_wrapper xil_defaultlib.acquireToHDMIwithZynq_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim acquireToHDMIwithZynq_wrapper -key {Behavioral:sim_1:Functional:acquireToHDMIwithZynq_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6da4.protoinst" -protoinst "protoinst_files/acquireToHDMIwithZynq.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_11 axi_infrastructure_v1_1_0 axi_vip_v1_1_21 processing_system7_vip_v1_0_23 xlconstant_v1_1_10 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_35)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb acquireToHDMIwithZynq_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./acquireToHDMIwithZynq_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: acquireToHDMIwithZynq_wrapper.sh [-help]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-step]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-lib_map_path]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-reset_run]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-reset_log]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-keep_index]\n\
Usage: acquireToHDMIwithZynq_wrapper.sh [-noclean_files]\n\n\
