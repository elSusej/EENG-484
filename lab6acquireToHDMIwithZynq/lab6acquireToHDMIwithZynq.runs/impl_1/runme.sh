...
HD_PWD='C:/EENG 484/lab6acquireToHDMIwithZynq/lab6acquireToHDMIwithZynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log acquireToHDMIwithZynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source acquireToHDMIwithZynq_wrapper.tcl -notrace
