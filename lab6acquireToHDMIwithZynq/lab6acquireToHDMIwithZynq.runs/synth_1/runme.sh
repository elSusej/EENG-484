...
HD_PWD='C:/EENG 484/lab6acquireToHDMIwithZynq/lab6acquireToHDMIwithZynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acquireToHDMIwithZynq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acquireToHDMIwithZynq_wrapper.tcl
