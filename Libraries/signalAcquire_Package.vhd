...
CONSTANT LONG_COUNTER_CONTROL_CW_BITS_INDEX : NATURAL := 6;
CONSTANT SHORT_COUNTER_CONTROL_CW_BITS_INDEX : NATURAL := 4;
CONSTANT RF_COUNTER_CONTROL_CW_BITS_INDEX : NATURAL := 2;
...
CONSTANT ALL_CHANNELS_HAVE_BEEN_READ_SW_BIT_INDEX  : NATURAL := 0;  
CONSTANT DATAPATH_SW_WIDTH : NATURAL := 3; --make first bit for short delay, second for long, and third for 8th RF write
CONSTANT DATAPATH_CW_WIDTH : NATURAL := 7;
CONSTANT AN7606_CW_WIDTH : NATURAL := 4;

CONSTANT START_CONV_SW_BIT_INDEX : NATURAL := 4;
CONSTANT BUSY_SW_BIT_INDEX : NATURAL := 3;

CONSTANT SW_WIDTH : NATURAL := 5; --DP sw width + 2 (DP only has 3 of total status bits)
CONSTANT CW_WIDTH : NATURAL := 11;

CONSTANT AN7606_DATA_WIDTH : NATURAL := 16;
CONSTANT RF_COUNTER_CONST_WIDTH : NATURAL := 3;
CONSTANT RF_COUNTER_LAST_CHANNEL : STD_LOGIC_VECTOR(RF_COUNTER_CONST_WIDTH - 1 downto 0) := "111";
CONSTANT CHANNEL0_ADDRESS : STD_LOGIC_VECTOR(RF_COUNTER_CONST_WIDTH - 1 downto 0) := "000";
...
CONSTANT FOURTH_THRESHOLD_CONSTANT : STD_LOGIC_VECTOR(15 downto 0)  := x"6666";
CONSTANT SECOND_THRESHOLD_CONSTANT : STD_LOGIC_VECTOR(15 downto 0)   := x"3333";
CONSTANT THIRD_THRESHOLD_CONSTANT : STD_LOGIC_VECTOR(15 downto 0) := x"4CCC";
CONSTANT FIRST_THRESHOLD_CONSTANT : STD_LOGIC_VECTOR(15 downto 0)   := x"1999"; --First threshold is 1V, all the way up to 4V
